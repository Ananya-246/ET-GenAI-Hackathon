...
const MOCK_ARTICLES = [
  ...
  { id: 2, title: "Reliance Industries posts ₹19,488 crore net profit, retail and Jio segments lead growth", category: "Industry", time: "3h ago" },
  { id: 3, title: "Sebi tightens F&O rules: weekly expiry contracts to be limited, lot sizes hiked", category: "Markets", time: "4h ago" },
  { id: 4, title: "IT sector outlook: TCS, Infosys brace for sluggish Q1 as BFSI clients defer spends", category: "Tech", time: "5h ago" },
  { id: 5, title: "EV startups face funding winter as global VCs tighten due diligence norms", category: "Startups", time: "6h ago" },
  { id: 6, title: "Union Budget 2026: Infrastructure capex likely to touch ₹11.1 lakh crore", category: "Economy", time: "7h ago" },
  { id: 7, title: "Adani Group secures ₹1.2 lakh crore order book; renewables at forefront", category: "Industry", time: "8h ago" },
  { id: 8, title: "SBI Card Q4 results: Net profit rises 11% to ₹662 crore on higher spends", category: "Finance", time: "9h ago" },
];

const AI_FEATURES = [
  { key: "my-et", icon: "🧠", title: "My ET", desc: "Your personalized newsroom — curated for your portfolio, sector & interests.", color: "#0f3460" },
  { key: "navigator", icon: "🔍", title: "News Navigator", desc: "Ask questions across all ET coverage. One briefing, not 8 articles.", color: "#16213e" },
  { key: "video", icon: "🎬", title: "AI Video Studio", desc: "Any article → broadcast-quality 90-second news video in seconds.", color: "#1a1a2e" },
  { key: "vernacular", icon: "🌐", title: "Vernacular Engine", desc: "Business news in Hindi, Tamil, Telugu & Bengali — culturally adapted.", color: "#0d1b2a" },
];
      ...
      <div className="ai-plugin-banner">
        <div className="container">
          ...
          <div className="plugin-cards-grid">
            {AI_FEATURES.map(f => (
              <button key={f.key} className="plugin-card" style={{ background: f.color }} onClick={() => setActivePage(f.key)}>
        ...
        <div className="home-main-grid">
          ...
          <div className="home-sidebar">
            ...
            <div className="sidebar-ai-card">
              ...
              <button className="btn-primary" style={{ width: "100%", marginTop: 10 }} onClick={() => setActivePage("navigator")}>
                Open News Navigator →
              </button>
            </div>
          </div>
