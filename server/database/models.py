...
def _seed_articles(conn):
    ...
    articles = [
        ...
        ("Reliance Industries posts record Q4 profit of Rs 19,488 crore", "Industry",
         "Retail and Jio segments drove growth for the conglomerate.",
         '["Reliance","RIL","profit","Q4 results","Jio","retail","Mukesh Ambani","conglomerate"]'),
        ...
        ("India GDP growth revised upward to 7.2% for FY27", "Economy",
        ...
        ("Nifty Bank options chain shows put writing at 47000 strike", "Markets",
         ...
         '["Nifty Bank","options","F&O","put writing","technical analysis","derivatives","strike"]'),
        ...
        ("SBI Card Q4 results: Net profit rises 11% to Rs 662 crore", "Finance",
         "Credit card spends surged 18% YoY driven by travel and retail.",
        ...
        ("C-suite salaries rise 18% in FY26 CFOs CTOs in highest demand", "Industry",
